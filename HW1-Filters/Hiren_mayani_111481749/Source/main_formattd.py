...
def help_message():
    ...
    print(sys.argv[0] + " 1 " + "[path to inumpyut image] " +
          "[output directory]")  # Single inumpyut, single output
    print(sys.argv[0] + " 2 " + "[path to inumpyut image1] " +
          "[path to inumpyut image2] " +
          "[output directory]")  # Two inumpyuts, three outputs
    print(sys.argv[0] + " 3 " + "[path to inumpyut image1] " +
          "[path to inumpyut image2] " +
          "[output directory]")  # Two inumpyuts, single output
...
def Question2():
    ...
    inumpyut_image2 = cv2.imread(sys.argv[3],
...
def Question3():
    ...
    succeed, output_image = laplacian_pyramid_blending(inumpyut_image1,
                                                       inumpyut_image2)

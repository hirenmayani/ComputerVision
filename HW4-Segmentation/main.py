...
def superpixels_histograms_neighbors(img):
    # SLIC
    segments = slic(img, n_segments=500, compactness=19.23)
...
def do_graph_cut(fgbg_hists, fgbg_superpixels, norm_hists, neighbors):
    ...
    g = maxflow.Graph[float](num_nodes, num_nodes * 10)
    # Add N nodes
...
if __name__ == '__main__':
    ...
    #TODO
    # get center, hist, segment and neigbours of SLIC super pixels
